...
const Welcomeframe: NextPage<WelcomeframeType> = ({ propMargin }) => {
  ...
  return (
    <div className="font-barlow mq800:pt-[3.438rem] mq800:pb-[3.438rem] mq800:box-border mq800:min-w-full mq1325:flex-1 mq1325:min-h-[auto] box-border flex min-h-screen w-[44.375rem] min-w-[44.375rem] max-w-full shrink-0 flex-row items-center justify-start overflow-hidden bg-[url('/images/shop/SignUpPage/account-frame@3x.png')] bg-cover bg-[top] bg-no-repeat px-[1.438rem] py-[5.25rem] text-left text-[2rem] text-neutral-white">
